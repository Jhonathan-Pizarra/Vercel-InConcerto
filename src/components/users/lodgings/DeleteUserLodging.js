...
const DeleteUserLodging = ({idLodging, idUser}) => {
    ...
    return (
        <div>
            ...
            >
                <DialogTitle id="alert-dialog-title">{"¿Deseas remover este hospedaje del usuario?"}</DialogTitle>
                <DialogActions>
...
export default DeleteUserLodging;
