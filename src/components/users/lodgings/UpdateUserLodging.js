...
const UpdateUserLodging = ({idLodging, idUser}) => {

    const classes = useStyles();
    const {data: lodging, error, mutate} = useSWR(`/users/${idUser}/lodgings/${idLodging}`, fetcher);
...
export default UpdateUserLodging;