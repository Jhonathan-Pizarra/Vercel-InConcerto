...
const UpdateLodgingArtist = ({idArtist, idLodging}) => {

    const classes = useStyles();
    const router = useRouter();
    //const {idConcert} = router.query;
    //const { data: concertArtists, mutate, error } = useSWR(`/artists/${idArtist}`, fetcher);
    const { data: lodgingArtists, mutate, error } = useSWR(`/lodgings/${idLodging}/artists/${idArtist}`, fetcher);
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            mutateTo(`/lodgings/${idLodging}/artists`);
            mutate();
            handleClose();
            setUpdateInfo(true);
        } catch (error) {
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <DialogContent>
                        ...
                        <TextField
                            ...
                            defaultValue={lodgingArtists.ciOrPassport}
                            type="number"
                        ...
                        <TextField
                            ...
                            defaultValue={lodgingArtists.artisticOrGroupName}
                            type="text"
                    ...
                    <DialogContent>
                        ...
                        <Grid container spacing={0}>
                            <Grid item xs={12} sm={6} md={6} lg={6}>
                                <TextField
                                    ...
                                    id="outlined-basic"
                                    label="Nombre"
                                    defaultValue={lodgingArtists.name}
                                    type="text"
                                    {...register('name')}
                                    fullWidth
                                />
                            ...
                            <Grid item xs={12} sm={6} md={6} lg={6}>
                                <TextField
                                    ...
                                    id="outlined-basic"
                                    label="Apellido"
                                    defaultValue={lodgingArtists.lastName}
                                    type="text"
                                    {...register('lastName')}
                                />
                            </Grid>
                        ...
                        <Grid container spacing={0}>
                            <Grid item xs sm={6} md={6} lg={6}>
                                <TextField
                                    ...
                                    id="outlined-basic"
                                    label="Nacionalidad"
                                    defaultValue={lodgingArtists.nationality}
                                    type="text"
                            ...
                            <Grid item xs sm={6} md={6} lg={6}>
                                <TextField
                                    ...
                                    id="standard-number"
                                    label="Teléfono"
                                    defaultValue={lodgingArtists.phone}
                                    type="number"
                                    {...register('phone')}
                                />
                        ...
                        <Grid container>
                            <TextField
                                ...
                                id="outlined-basic"
                                label="E-mail"
                                defaultValue={lodgingArtists.mail}
                                type="text"
                                {...register('mail')}
                                fullWidth
                            />
                    ...
                    <DialogContent style={{textAlign: 'center'}}>
                        ...
                        <TextField
                            ...
                            defaultValue={lodgingArtists.instruments}
                            type="text"
                            multiline
                            rows={3}
                            rowsMax={6}
                        ...
                        <Grid container spacing={0}>
                            <Grid item xs sm={6} md={6} lg={6}>
                                <TextField
                                    ...
                                    defaultValue={lodgingArtists.emergencyPhone}
                                    type="number"
                            ...
                            <Grid item xs sm={6} md={6} lg={6}>
                                <TextField
                                    ...
                                    defaultValue={lodgingArtists.emergencyMail}
                                    type="text"
                    ...
                    <DialogContent>
                        ...
                        <Select
                            ...
                            fullWidth
                            native
                            defaultValue={lodgingArtists.foodGroup}
                    ...
                    <DialogContent>
                        <TextField
                            ...
                            id="outlined-basic"
                            label="Observación"
                            defaultValue={lodgingArtists.observation}
                            type="text"
                            multiline
                            rows={3}
                            rowsMax={6}
...
export default UpdateLodgingArtist;