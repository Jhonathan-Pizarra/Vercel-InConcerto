...
const DeleteCalendar = ({id}) => {
    ...
    return (
        <div>
            ...
            >
                <DialogTitle id="alert-dialog-title">{"¿Deseas eliminar este calendario?"}</DialogTitle>
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        🎼 Asegúrese de no tener un <strong><em>artista</em></strong> o un <strong><em>responsable</em></strong> en éste calendario primero.🎵 <br/>
