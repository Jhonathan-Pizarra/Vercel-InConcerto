...
const UpdateArtistLodging = ({idLodging, idArtist}) => {

    const classes = useStyles();
    const {data: lodging, error, mutate} = useSWR(`/artists/${idArtist}/lodgings/${idLodging}`, fetcher);
    ...
    const onSubmit = async (data) => {
        ...
        try {
            setProcessing(true);
            await Lodging.update(idLodging, {
                ...data,
...
export default UpdateArtistLodging;